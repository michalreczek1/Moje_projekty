...
public class Biblioteka implements Dzialania {
    ...
    static public ArrayList<Ksiazka> listaKsiazek = new ArrayList<>();
    ...
    public void menu() throws IOException {
        ...
        while (true) {
            ...
            if (menu.equals("W")) {
                ...
                String dane = json.toJson(listaKsiazek);

                PrintWriter plik = new PrintWriter("C:\\Users\\micha\\IdeaProjects\\Kurs_java_ALX\\src\\BibliotekaJSON\\ksiazki.txt");
                plik.println(dane);
                plik.close();

                String dane2 = json.toJson(listaOsob);
                FileWriter plik2 = new FileWriter("C:\\Users\\micha\\IdeaProjects\\Kurs_java_ALX\\src\\BibliotekaJSON\\wypozyczone.txt", false);
                plik2.append(dane2);
                plik2.close();
                break;
            } else {
